...
CXX := clang++
CPPFLAGS := -MMD
CXXFLAGS := -std=c++23 -Werror -pedantic-errors -Weverything -Wno-c++98-compat -Wno-pre-c++20-compat-pedantic -Wno-padded -Wno-poison-system-directories -Wno-missing-designated-field-initializers
OPT := -O3 -DNDEBUG
DEBUG := -g3 -DDEBUG
